...
namespace KaimiraGames
{
    ...
    public class WeightedList<T> : IEnumerable<T>
    {
        ...
        public T Next()
        {
            ...
            return (nextProbability < _probabilities[nextInt])
                ? _list[nextInt]
                : _list[_alias[nextInt]];
        }
        ...
        private void Recalculate()
        {
            ...
            while (small.Count > 0 && large.Count > 0)
            {
                ...
                _alias[l] = g; // 5.4
                int tmp =
                    scaledProbabilityNumerator[g] + scaledProbabilityNumerator[l] - _totalWeight; // 5.5, even though using ints for this algorithm is stable
...
#pragma warning restore S125 // Sections of code should not be commented out
        ...
        private int FixWeight(int weight) =>
            (BadWeightErrorHandling == ThrowExceptionOnAdd)
